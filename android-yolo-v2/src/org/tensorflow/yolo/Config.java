...
//    String LABEL_FILE = "tiny-yolo-voc-labels.txt"; // The filepath of label file for classes.
    String MODEL_FILE = "yolov2_tiny_voc_30000.pb";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "tiny-yolo-voc-labels_rsp.txt"; // The filepath of label file for classes.
